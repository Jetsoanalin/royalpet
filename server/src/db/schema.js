...
const TABLE_COLUMNS = {
  ...
  pets: ["id", "name", "type", "breed", "dob", "sex", "weight", "ownerId", "photo", "alerts", "color", "createdAt", "updatedAt"],
  visits: ["id", "petId", "caseNum", "date", "status", "reason", "temp", "hr", "rr", "weight", "diagnosis", "notes", "doctorId", "emergency", "inventoryDeducted", "createdAt", "updatedAt"],
  prescriptions: ["id", "visitId", "medicines", "createdAt", "updatedAt"],
  appointments: ["id", "petId", "ownerId", "date", "time", "type", "status", "notes", "createdAt", "updatedAt"],
